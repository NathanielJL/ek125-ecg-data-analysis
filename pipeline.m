...
% Part 2: Steps 4-6 (findpeaks with default and tuned parameters, overlay heartbeats)
% Part 3: Steps 7-9 (heart rate analysis, pulse speed, t-tests)
...
% R-R intervals using both manual calculation and diff() function
% Manual: RR(i) = R_times_rest_win(i+1) - R_times_rest_win(i) for each i
% Using diff: computes exactly this for all elements
...
subplot(2,1,2)
histogram(HR_ex, 'Normalization', 'probability')
xlabel('Heart Rate (BPM)')
ylabel('Probability')
